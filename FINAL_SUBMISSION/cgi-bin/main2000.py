...
"""@auto-doc
This package shows the year of 2000 carbon emission data of united states. The data is shown on the map. The map is color
...
<head>
   <title> Carbon Emissions (2000) </title>
...
<body style="margin-left: 200px; margin-right: 200px; margin-top: 50px; margin-bottom: 50px;">
  ...
  <p>
  The map below visualizes data taken from the U.S. Energy Information Administration (EIA) Website for annual carbon emissions per State in Million Metric tons of CO<sub>2</sub>, and includes a breakdown of the individual contributions in each state due to Petroleum, Gas, and Coal.</p></br>
...
<p>
   Carbon occurs naturally in the atmosphere, however, human activities alter the carbon cycle by adding more CO<sub>2</sub> to it. The main human activity that emits CO<sub>2</sub> is the combustion of fossil fuels (oil, natural gas, and coal).
   </P>
   <p>
